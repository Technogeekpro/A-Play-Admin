  ...
  useEffect(() => {
    if (liveShow) {
      setFormData({
        ...
        show_date: liveShow.show_date || "",
        show_time: liveShow.show_time || "",
        duration_minutes: liveShow.duration_minutes || "",
        cover_image: liveShow.cover_image || "",
        genre: liveShow.genre || [],
        ticket_price_min: liveShow.ticket_price_min || "",
        ticket_price_max: liveShow.ticket_price_max || "",
        ticket_url: liveShow.ticket_url || "",
        capacity: liveShow.capacity || "",
